...
import com.oazisn.filepicker.processors.tasks.GetFileTask
import com.oazisn.filepicker.utils.loge

/**
 * Created by bison on 31/10/17.
 */
class GoogleMediaProcessor : IUriProcessor {
    ...
    override fun process(
        ...
        GetFileTask(context, uri, object : GetFileTask.TaskListener {
            override fun didSucceed(path: String?) {
                val intent = Intent()
    ...
    companion object {
        val TAG = GoogleMediaProcessor::class.java.simpleName
