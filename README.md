...
This project is based on https://github.com/nodes-android/filepicker repo.
I try to:
  - Migration to Kotlin
  - Minimize duplication
  - Not copying files to /data/data/<package.name> directory. (hopefully can take the original path on an android device)
  - Implement Testing
  
Feel free to make a pull request of this repo. I will check 😊
